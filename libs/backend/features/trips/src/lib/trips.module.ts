...
@Module({
  imports: [PrismaModule, DestinationsModule, AccommodationsModule, InventoryModule, BudgetModule, TripMembersModule, InvitationsModule, TransportModule, ActivityModule],
