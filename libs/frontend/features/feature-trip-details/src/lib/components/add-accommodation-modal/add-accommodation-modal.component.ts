...
@Component({
  ...
  styles: [`
    ...
    .backdrop {
      ...
      z-index: 200; animation: backdropFade 180ms ease; padding: 20px;
    }
    .modal {
    ...
    .modal-title { margin: 0 0 4px; font-size: 1.15rem; font-weight: 700; color: #111827; }
    .modal-subtitle { margin: 0; font-size: 0.82rem; color: #6b7280; }
    .close-btn {
    ...
    .field-label { font-size: 0.82rem; font-weight: 600; color: #374151; letter-spacing: 0.01em; }
    .optional-label { font-weight: 400; color: #9ca3af; margin-left: 4px; }
    .field-input {
      border: 1.5px solid #e5e7eb; border-radius: 10px; padding: 10px 14px;
      font-size: 0.92rem; color: #111827; outline: none; transition: border-color 150ms;
    ...
    .input-prefix { position: absolute; left: 13px; top: 50%; transform: translateY(-50%); font-size: 0.9rem; color: #6b7280; pointer-events: none; }
    .field-input--icon { padding-left: 36px; }
    .field-input--prefix { padding-left: 26px; }
    .select-wrapper { position: relative; }
    .field-select {
      width: 100%; border: 1.5px solid #e5e7eb; border-radius: 10px;
      padding: 10px 36px 10px 14px; font-size: 0.92rem; color: #111827;
      outline: none; appearance: none; background: #fff; cursor: pointer;
    ...
    .select-chevron { position: absolute; right: 12px; top: 50%; transform: translateY(-50%); pointer-events: none; color: #6b7280; }
    .modal-footer { display: flex; gap: 10px; margin-top: 28px; }
    .btn-cancel {
      flex: 0 0 auto; padding: 10px 18px; border: 1.5px solid #e5e7eb; border-radius: 10px;
      background: none; font-size: 0.9rem; font-weight: 500; color: #374151;
